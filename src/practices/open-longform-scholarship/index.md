...
layout: practice.njk
---
*Disciplines include: English, history, philosophy, social and cultural anthropology*
...
Adema, J. (2021). *Living Books: Experiments in the Posthumanities*. MIT Press. [https://doi.org/10.7551/mitpress/13642.003.0001](https://doi.org/10.7551/mitpress/13642.003.0001).
Adema theorises the monograph as a ‘living, collaborative, and iterative’ form, challenging the fixity and closure historically associated with the printed book and arguing for open, processual models of longform scholarship grounded in digital and community-led infrastructures.

Community-led Open Publication Infrastructures for Monographs (COPIM). (2019–2023). COPIM Project Outputs. [https://copim.pubpub.org](https://copim.pubpub.org).
COPIM provides a major example of open longform scholarship in practice, developing community-governed infrastructures, funding models, and open-source tools that remove barriers to publishing open-access monographs while centring scholar-led and library-supported approaches to sustainability. 

Open Book Collective. (2023). Open Book Collective Platform. [https://openbookcollective.org](https://openbookcollective.org).
The Open Book Collective is a nonprofit platform emerging from COPIM that enables libraries to collectively fund open-access publishers, preserving bibliodiversity and supporting longform scholarship outside commercial and author-pays models.

Moore, S. (2025). *Publishing Beyond the Market: Open Access, Care, and the Scholar-Led Press*. Cambridge University Press. [https://doi.org/10.3998/mpub.11781635](https://doi.org/10.3998/mpub.11781635).
Moore analyses scholar-led and community-led publishing models, including COPIM and Opening the Future, arguing for pragmatic, care-based approaches to openness.
